...
data class LumeColors(
     ...
     *
     * Ainda **não usado**: foco visível de teclado é exigência de acessibilidade
     * do documento e não foi implementado. O token fica porque ele é a
     * especificação; apagá-lo apagaria junto o registro do que falta.
     */
    val focusRing: Color,
